...
def _build_deeplab(inputs_queue, outputs_to_num_classes, ignore_label, global_step):
...
def main(unused_argv):
  ...
  if os.path.exists(os.path.join(FLAGS.train_logdir, 'model.ckpt-%d.meta'%FLAGS.training_number_of_steps)):
      return
  ...
  with tf.Graph().as_default() as graph:
    ...
    with tf.device(config.variables_device()):
      ...
      }, dataset.ignore_label, global_step)
