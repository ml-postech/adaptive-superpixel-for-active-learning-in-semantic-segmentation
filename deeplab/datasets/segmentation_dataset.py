...
def get_dataset(dataset_name, split_name, dataset_dir):
  ...
  keys_to_features = {
      ...
      'image/sp_labels': tf.FixedLenFeature(
          (), tf.string, default_value=''),
      'image/mil_labels': tf.FixedLenFeature(
          (), tf.string, default_value=''),
      'image/dorm_labels': tf.FixedLenFeature(
          (), tf.string, default_value=''),
      'image/region_num_per_image': tf.FixedLenFeature(
          (), tf.int64, default_value=0),
      'image/num_class': tf.FixedLenFeature(
          (), tf.int64, default_value=0),
  }
  items_to_handlers = {
      ...
      'sp_labels': tfexample_decoder.Tensor('image/sp_labels'),
      'mil_labels': tfexample_decoder.Tensor('image/mil_labels'),
      'dorm_labels': tfexample_decoder.Tensor('image/dorm_labels'),
      'region_num_per_image': tfexample_decoder.Tensor('image/region_num_per_image'),
      'num_class':tfexample_decoder.Tensor('image/num_class'),
  }
